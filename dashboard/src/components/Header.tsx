  ...
  return (
    <header className="shrink-0 z-40 bg-white/80 dark:bg-zinc-900/70 backdrop-blur-xl border-b border-gray-200 dark:border-white/10">
      <div className="max-w-7xl mx-auto px-3 md:px-4 py-2 flex items-center gap-2.5">
        <Link href="/dashboard" className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-[10px] font-bold shadow-sm shadow-blue-500/30 shrink-0">
          ZM
        </Link>
