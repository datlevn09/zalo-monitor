  ...
  return (
    <div className="flex flex-col h-screen md:h-[calc(100vh)]">
      ...
      <div ref={messagesContainerRef} className="flex-1 overflow-auto bg-[#f2f2f7] dark:bg-zinc-950">
        ...
        {/* Nút "cuộn về cuối" — hiện khi user cuộn lên, ẩn khi đang ở gần đáy */}
        {showScrollDown && (
          <button
            onClick={() => messagesEndRef.current?.scrollIntoView({ behavior: 'smooth' })}
            aria-label="Cuộn về tin mới nhất"
            className="fixed bottom-24 right-4 md:right-8 z-20 w-10 h-10 rounded-full bg-white dark:bg-zinc-800 shadow-lg border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-700 dark:text-zinc-200 hover:bg-gray-50 dark:hover:bg-zinc-700 transition"
          >
